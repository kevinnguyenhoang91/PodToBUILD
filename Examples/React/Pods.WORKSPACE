...
new_pod_repository(
  ...
  install_script = """
    ...
    find . \( -iname "*.h" -o -iname "*.cpp" -o -iname "*.m" -o -iname "*.mm" \) -exec sed -i '' 's,folly_hazptr_use_executor,follyflipper_hazptr_use_executor,g' "{}" \;
    __INIT_REPO__
    rm -rf pod_support/Headers/Public/RSocket
    cp -RLf rsocket pod_support/Headers/Public/
    find pod_support/Headers/Public -iname "*.cpp" -delete
    %s
  """ % PATCH_CMDS,
)
...
new_pod_repository(
  ...
  install_script = """
    ...
    find . \( -iname "*.h" -o -iname "*.cpp" -o -iname "*.m" -o -iname "*.mm" \) -exec sed -i '' 's,folly_reqctx_use_hazptr,follyflipper_reqctx_use_hazptr,g' "{}" \;
    find . \( -iname "*.h" -o -iname "*.cpp" -o -iname "*.m" -o -iname "*.mm" \) -exec sed -i '' 's,folly_hazptr_use_executor,follyflipper_hazptr_use_executor,g' "{}" \;
    sed -i '' 's,./scripts/ios-configure-glog.sh,../React/scripts/ios-configure-glog.sh,g' Flipper-Glog.podspec
    sh ../React/scripts/ios-configure-glog.sh
    __INIT_REPO__
    %s
  """ % PATCH_CMDS,
...
new_pod_repository(
    ...
    url = "https://registry.yarnpkg.com/react-native-safe-area-context/-/react-native-safe-area-context-3.1.8.tgz",
    strip_prefix = "package",
    install_script = """
        __INIT_REPO__
        %s
...
new_pod_repository(
    ...
    url = "https://registry.yarnpkg.com/react-native-view-shot/-/react-native-view-shot-3.1.2.tgz#8c8e84c67a4bc8b603e697dbbd59dbc9b4f84825",
    strip_prefix = "package",
    install_script = """
        __INIT_REPO__
        %s
...
new_pod_repository(
    ...
    url = "https://registry.yarnpkg.com/@react-native-async-storage/async-storage/-/async-storage-1.13.2.tgz#649f78527f16cd5a87071a888219ef7a35ef5c79",
    strip_prefix = "package",
    install_script = """
    __INIT_REPO__
    %s
...
new_pod_repository(
    name = "RNSVG",
    url = "https://registry.yarnpkg.com/react-native-svg/-/react-native-svg-12.1.0.tgz#acfe48c35cd5fca3d5fd767abae0560c36cfc03d",
    strip_prefix = "package",
    install_script = """
    __INIT_REPO__
    %s
...
new_pod_repository(
    ...
    url = "https://registry.yarnpkg.com/@react-native-community/datetimepicker/-/datetimepicker-3.0.8.tgz#3960b39dfeea4a0f11425e24e0852764ed9133ca",
    strip_prefix = "package",
    install_script = """
    __INIT_REPO__
    %s
...
new_pod_repository(
    name = "RNVectorIcons",
    url = "https://registry.yarnpkg.com/react-native-vector-icons/-/react-native-vector-icons-8.0.0.tgz#deb8b344ff68ea67f4659c8de493fef8a9e717d2",
    strip_prefix = "package",
    install_script = """
    __INIT_REPO__
    %s
...
new_pod_repository(
    ...
    url = "https://registry.yarnpkg.com/react-native-webview/-/react-native-webview-11.4.3.tgz#7651370b604c8cc27701095e14e05cfefa8f5632",
    strip_prefix = "package",
    install_script = """
    __INIT_REPO__
    %s
