...
Pod::Spec.new do |s|
  ...
  s.library                = "stdc++"
  s.pod_target_xcconfig    = { "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\" \"$(PODS_ROOT)/boost-for-react-native\" \"$(PODS_ROOT)/DoubleConversion\" \"$(PODS_ROOT)/RCT-Folly\" \"$(PODS_TARGET_SRCROOT)/pod_support\" \"$(PODS_TARGET_SRCROOT)/pod_support/React\" \"$(PODS_ROOT)/hermes-engine/pod_support/Headers/Public\" \"$(PODS_TARGET_SRCROOT)/ReactCommon/hermes/executor\" \"$(PODS_TARGET_SRCROOT)/ReactCommon/hermes/inspector\" \"$(PODS_TARGET_SRCROOT)/ReactCommon/hermes/chrome\" \"$(PODS_TARGET_SRCROOT)/ReactCommon/hermes/detail\"", "DEFINES_MODULE" => "YES" }
  s.user_target_xcconfig   = { "HEADER_SEARCH_PATHS" => "\"$(PODS_ROOT)/Headers/Private/React-Core\""}
  s.default_subspec        = "Default"

  s.subspec "Default" do |ss|
    ss.source_files           = "React/**/*.{c,m,mm,S,cpp}"
  ...
  s.subspec "Hermes" do |ss|
    ...
    ss.source_files = "ReactCommon/hermes/executor/*.{cpp}",
                      "ReactCommon/hermes/inspector/*.{cpp}",
                      "ReactCommon/hermes/inspector/chrome/*.{cpp}",
                      "ReactCommon/hermes/inspector/detail/*.{cpp}"
    ss.pod_target_xcconfig = { "GCC_PREPROCESSOR_DEFINITIONS" => "HERMES_ENABLE_DEBUGGER=1", "HEADER_SEARCH_PATHS" => "\"$(PODS_TARGET_SRCROOT)/ReactCommon\"" }
  ...
  s.subspec "DevSupport" do |ss|
    ss.source_files = "React/DevSupport/*.{mm,m}",
  ...
  s.subspec "RCTWebSocket" do |ss|
    ss.source_files = "Libraries/WebSocket/*.{m}"
    ss.dependency "React-Core/Default", version
  end
